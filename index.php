        ...
        <div class="slide-item">
            ...
            <div class="auto-container">
                <div class="content-box">
                    <div class="content">
                        <div class="inner">
                            <div class="sub-title">welcome to Cybertron agency</div>
        ...
        <div class="row clearfix">
            ...
            <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms"
                ...
                <div class="inner-box">
                    ...
                    <h6><a href="web-development.php">Website <br>Development</a></h6>
                </div>
            </div>
            <!--Service Block-->
            <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="300ms"
                ...
                <div class="inner-box">
                    ...
                    <h6><a href="graphic-designing.php">graphic <br>designing</a></h6>
                </div>
            </div>
            <!--Service Block-->
            <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms"
                ...
                <div class="inner-box">
                    ...
                    <h6><a href="digital-marketing.php">digital <br>marketing</a></h6>
                </div>
            </div>
            <!--Service Block-->
            <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="300ms"
                ...
                <div class="inner-box">
                    ...
                    <h6><a href="seo.php">seo & content <br>writing</a></h6>
                </div>
            </div>
            <!--Service Block-->
            <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="600ms"
                ...
                <div class="inner-box">
                    ...
                    <h6><a href="app-development.php">App <br>Development</a></h6>
                </div>
            </div>
            <!--Service Block-->
                    ...
                    <div class="round-inner">
                        <div class="vid-link">
                            <a href="https://www.youtube.com/watch?v=Get7rqXYrbQ" class="lightbox-image">
                                <div class="icon"><span class="flaticon-play-button-1"></span><i class="ripple"></i>
                                </div>
                            </a>
                        </div>
                        <div class="title">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="cap-box">
                                    <div class="cap-inner">
                                        ...
                                        <div class="title">
                                            <h5><a href="services-2.php">Fimlor Experience</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="carousel-box">
        <div class="team-carousel owl-theme owl-carousel">
            ...
            <div class="team-block">
                <div class="inner-box">
                    <div class="image-box">
                        <a href="about.php"><img src="images/resource/team-1.jpg" alt=""></a>
            ...
            <div class="team-block">
                <div class="inner-box">
                    <div class="image-box">
                        <a href="about.php"><img src="images/resource/team-2.jpg" alt=""></a>
                        <ul class="social-links clearfix">
                            <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
            ...
            <div class="team-block">
                <div class="inner-box">
                    <div class="image-box">
                        <a href="about.php"><img src="images/resource/team-3.jpg" alt=""></a>
                        <ul class="social-links clearfix">
                            <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
            ...
            <div class="team-block">
                <div class="inner-box">
                    <div class="image-box">
                        <a href="about.php"><img src="images/resource/team-4.jpg" alt=""></a>
                        <ul class="social-links clearfix">
                            <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
            ...
            <div class="team-block">
                <div class="inner-box">
                    <div class="image-box">
                        <a href="about.php"><img src="images/resource/team-5.jpg" alt=""></a>
                        <ul class="social-links clearfix">
                            <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
    ...
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0ms"
                ...
                <div class="inner-box">
                    <div class="image-box">
                        <a href="blog-grid.php"><img src="images/resource/news-1.jpg" alt=""></a>
                    </div>
                    <div class="lower-box">
                        <div class="post-meta">
                            <ul class="clearfix">
                        ...
                        <h5><a href="blog-grid.php">basic rules of running web agency business</a></h5>
                        <div class="text">Lorem ipsum is simply free text used by copytyping refreshing.</div>
                        <div class="link-box"><a class="theme-btn" href="blog-grid.php"><span
            ...
            <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms"
                ...
                <div class="inner-box">
                    <div class="image-box">
                        <a href="blog-grid.php"><img src="images/resource/news-2.jpg" alt=""></a>
                    </div>
                    <div class="lower-box">
                        <div class="post-meta">
                            <ul class="clearfix">
                        ...
                        <h5><a href="blog-grid.php">Delivering the best digital marketing</a></h5>
                        <div class="text">Lorem ipsum is simply free text used by copytyping refreshing.</div>
                        <div class="link-box"><a class="theme-btn" href="blog-grid.php"><span
                                    class="flaticon-next-1"></span></a></div>
                    </div>
            ...
            <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms"
                ...
                <div class="inner-box">
                    <div class="image-box">
                        <a href="blog-grid.php"><img src="images/resource/news-3.jpg" alt=""></a>
                    </div>
                    <div class="lower-box">
                        <div class="post-meta">
                            <ul class="clearfix">
                        ...
                        <h5><a href="blog-grid.php">Introducing the latest Cybertron features</a></h5>
                        <div class="text">Lorem ipsum is simply free text used by copytyping refreshing.</div>
                        <div class="link-box"><a class="theme-btn" href="blog-grid.php"><span
                                    class="flaticon-next-1"></span></a></div>
                    </div>
...
<!-- <div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="images/background/b-shape-2.png" alt="">
        </div>
    </div>
</div> -->
...
<section class="call-to-section">
    <div class="auto-container">
        <div class="inner clearfix">
            ...
            <div class="link-box">
                <a class="theme-btn btn-style-two" href="contact-2.php">
                    <i class="btn-curve"></i>
