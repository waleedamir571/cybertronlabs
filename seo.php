                        ...
                        <aside class="sidebar blog-sidebar">
                            ...
                            <div class="sidebar-widget services">
                                <div class="widget-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="seo.php">SEO & Content Writting</a></li>
                                        <li><a href="app-development.php">App Development</a></li>
                                        <li><a href="ui-designing.php">UI/UX Designing</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-widget call-up">
                                <div class="widget-inner">
                                    ...
                                    <div class="phone"><a href="tel:666888000"><span class="icon flaticon-call"></span>
                                            666 888 000</a></div>
                                </div>
                            </div>
